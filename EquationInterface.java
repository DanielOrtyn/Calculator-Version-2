 ...
 * @version 0.1
 * @since Oct 31, 2017
 * @deprecated paren not implemented
 */
public class EquationInterface extends JFrame {
	...
	public EquationInterface() {
		...
		btnAddition.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnSolve.setFont(new Font("Tahoma", Font.PLAIN, 15));
		...
		sl_keyBoard.putConstraint(SpringLayout.SOUTH, btn7, 50, SpringLayout.NORTH, keyBoard);
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn7, 50, SpringLayout.WEST, keyBoard);
		// button 4
		...
		sl_keyBoard.putConstraint(SpringLayout.SOUTH, btn4, 50 + 5, SpringLayout.SOUTH, btn7);
		...
		sl_keyBoard.putConstraint(SpringLayout.SOUTH, btn1, 50 + 5, SpringLayout.SOUTH, btn4);
		...
		sl_keyBoard.putConstraint(SpringLayout.SOUTH, btn0, 50 + 5, SpringLayout.SOUTH, btn1);
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn0, (50 + 5) * 2 - 5, SpringLayout.WEST, keyBoard);
		// button 8
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn8, 50 + 5, SpringLayout.EAST, btn7);
		// button 5
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn5, 50 + 5, SpringLayout.EAST, btn4);
		// button 2
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn2, 50 + 5, SpringLayout.EAST, btn1);
		// button 9
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn9, 50 + 5, SpringLayout.EAST, btn8);
		// button 6
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn6, 50 + 5, SpringLayout.EAST, btn5);
		// button 3
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btn3, 50 + 5, SpringLayout.EAST, btn2);
		// button .
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btnFullStop, 50 + 5, SpringLayout.EAST, btn0);
		// button /
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btnDivide, 50 + 5, SpringLayout.EAST, btn9);
		// button *
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btnMultiplication, 50 + 5, SpringLayout.EAST, btn6);
		// button -
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btnSubtract, 50 + 5, SpringLayout.EAST, btn3);
		// button +
		...
		sl_keyBoard.putConstraint(SpringLayout.EAST, btnAddition, 50 + 5, SpringLayout.EAST, btnFullStop);
		// button =
		sl_keyBoard.putConstraint(SpringLayout.NORTH, btnSolve, 0, SpringLayout.NORTH, btnDivide);
		sl_keyBoard.putConstraint(SpringLayout.WEST, btnSolve, 5, SpringLayout.EAST, btnDivide);
		sl_keyBoard.putConstraint(SpringLayout.SOUTH, btnSolve, 0, SpringLayout.SOUTH, btnFullStop);
		sl_keyBoard.putConstraint(SpringLayout.EAST, btnSolve, 50 + 5, SpringLayout.EAST, btnDivide);
	...
	private void setupKeyboardBindings() {
		...
		typeAction = new TypeLetter(this, '*');
		enableTypeAction = new SetActionEnable(typeAction, true);
		actionHolder.getActionMap().put("pressed ASTERISK", enableTypeAction);
		...
		// = key
		typeAction = new EvaluateEquation(this);
		enableTypeAction = new SetActionEnable(typeAction, true);
	...
	public synchronized String evaluateEquation() {
		...
		if (newEquation.isValid() == false) {
			...
			returnVal = Double.toString(newEquation.solveEquationAndSetToResult());
			this.equationDisplay.setText(returnVal);
		}
	...
	public synchronized void addChar(char charToAdd){
		...
		// display didn't need to be cleared so just place the char in like normal
		else {
